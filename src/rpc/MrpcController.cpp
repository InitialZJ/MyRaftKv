...
bool MrpcController::Failed() const { return isfail; }
...
std::string MrpcController::ErrorText() const { return failtext; }

void MrpcController::StartCancel() {}

bool MrpcController::IsCanceled() const { return true; }
